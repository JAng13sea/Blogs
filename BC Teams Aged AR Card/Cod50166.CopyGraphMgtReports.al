codeunit 50166 "Copy Graph Mgt - Reports"
{
    ...
    begin
        ...
        AgedReportEntity.CalcSums("Period 4");
        AgedReportEntity."Period 4" := AgedReportEntity."Period 4";
    ...
    begin
        ...
        PeriodStartDate[6] := DMY2Date(1, 1, 1753);
        ...
        case RecRef.Number of
            DATABASE::"Detailed Cust. Ledg. Entry":
                begin
                    ...
                    case PeriodCount of
                        5:
                            AgedReportEntity."Period 4" := DetailedCustLedgEntry."Amount (LCY)";
                        4:
